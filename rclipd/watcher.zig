...
pub fn Watcher(comptime T: type) type {
    return struct {
        ...
        current_offer: ?*T.DataControlOfferV1,
        ...
        fn dataControlListener(device: *T.DataControlDeviceV1, event: T.DataControlDeviceV1.Event, self: *Self) void {
            switch (event) {
                .data_offer => |ev| {
        ...
        fn dataControlOfferListener(_: *T.DataControlOfferV1, event: T.DataControlOfferV1.Event, self: *Self) void {
            switch (event) {
                .offer => |ev| {
        ...
        fn requestData(offer: *T.DataControlOfferV1, mime: [*:0]const u8) !i32 {
